...
if (isset($_POST['btn_submit'])) {
    ...
    // call to function should be inside the isset
    getDetails($full_name, $email);
}


// created function should be outside isset
function getDetails($full_name, $email)
{
